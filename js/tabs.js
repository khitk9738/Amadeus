...
if( tab2_importance_data.length == 0 ){
	var broken_html = "<div class='summary_tab_inside'>"
					+ "<img style='width:60%;margin-left:20%;position:relative' src='" + chrome.extension.getURL("images/summary_missing.png") + "'>"
...
if( timeline.length == 0 ){
	var broken_html = "<div class='summary_tab_inside'>"
					+ "<img style='width:60%;margin-left:20%;position:relative' src='" + chrome.extension.getURL("images/timeline_missing.png") + "'>"
