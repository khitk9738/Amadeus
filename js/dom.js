...
function openClose(id){
	...
	if( document.getElementById("bottom_tab" + id).style.bottom == "0%" || document.getElementById("bottom_tab" + id).style.bottom == "" ){
		...
		document.getElementById("bottom_tab" + id).style.backgroundColor = "#ff5722";
		...
		document.getElementById("bottom_tab" + id).style.borderColor = "#888888";
		document.getElementById("bottom_tab" + id).style.backgroundColor = "#b23c17";
		...
		for( var i=1;i<=BUTTON_NUMBER;i++){
			if( i != id ){
				...
				document.getElementById("bottom_tab" + i).style.backgroundColor = "#ff5722";
